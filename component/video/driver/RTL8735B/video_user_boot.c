...
video_boot_stream_t video_boot_stream = {
	...
	.video_params[STREAM_V1].fps = sensor_params[USE_SENSOR].sensor_fps,
	.video_params[STREAM_V1].gop = sensor_params[USE_SENSOR].sensor_fps << 1,
			...
			.video_params[STREAM_V2].gop = sensor_params[USE_SENSOR].sensor_fps << 1,
