...
static crypto_uint32 R(crypto_uint32 x, int c)
{
	return (x >> c) | ((x & 0xffffffff) << (32 - c));
}
static crypto_uint32 Ch(crypto_uint32 x, crypto_uint32 y, crypto_uint32 z)
{
	return (x & y) ^ (~x & z);
}
static crypto_uint32 Maj(crypto_uint32 x, crypto_uint32 y, crypto_uint32 z)
{
	return (x & y) ^ (x & z) ^ (y & z);
}
static crypto_uint32 Sigma0(crypto_uint32 x)
{
	return R(x, 2) ^ R(x, 13) ^ R(x, 22);
}
static crypto_uint32 Sigma1(crypto_uint32 x)
{
